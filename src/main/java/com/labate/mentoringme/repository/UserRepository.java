  ...
  @Query(
      value =
          "SELECT DISTINCT user "
              ...
              + " OR address.province.id IN (:#{#request.addressIds})"
              + " OR address.district.id IN (:#{#request.addressIds})"
              + ") "
              ...
              + "or userProfile.address.name like %:#{#request.keyword}% "
              + "or userProfile.address.province.name like %:#{#request.keyword}% "
              + "or userProfile.address.district.name like %:#{#request.keyword}% "
              + ") ",
      countQuery =
